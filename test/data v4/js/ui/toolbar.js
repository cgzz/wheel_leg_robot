...
function handleToggleRun() {
    wsSend({ type: 'toggle_run', running: elements.runSwitch.checked });
}
...
function handleToggleCharts() {
    ...
    wsSend({ type: 'charts_on', on: isEnabled });
}
...
function handleToggleFallDetect() {
    wsSend({ type: 'fall_detect', enable: elements.fallDetectSwitch.checked });
}
