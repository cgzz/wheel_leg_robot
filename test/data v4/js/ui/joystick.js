...
function updateJoystick(e) {
    ...
    joyOut.textContent = `x: ${joyX.toFixed(2)} y: ${joyY.toFixed(2)} r: ${joyR.toFixed(2)} θ: ${joyA.toFixed(1)}°`;
    wsSend({ type: 'joy', x: joyX, y: joyY, deg: joyA });
}
